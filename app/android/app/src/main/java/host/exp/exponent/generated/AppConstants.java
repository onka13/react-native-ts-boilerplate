...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@onka13/rn-boilerplate";
  public static final boolean IS_DETACHED = true;
  public static final String SHELL_APP_SCHEME = "rnboilerplate";
  public static final String RELEASE_CHANNEL = "android-v1";
  public static boolean SHOW_LOADING_VIEW_IN_SHELL_APP = false; //true for "cover", false for "contain"
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@onka13/cms9", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40onka13%2Fcms9%2F1.0%2Fd88d5a0e1eae2fe2cec962fe72770b92-33.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
